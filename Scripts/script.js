document.addEventListener('DOMContentLoaded', () => {
    ...
    const endGame = () => {
        ...
        feedbackMessage.innerHTML = `
           <h2 style="color: #FFA500;">🎉Great Job!🎉</h2>
            <p style="color: #FFFFFF;">You answered ${correctAnswers} out of 5 questions correctly.</p>
            <p style="color: #FFFFFF;">Time taken: ${timeTaken} seconds.</p>
            <button id="back-to-menu" onclick="window.location.href='menu.html'">◄</button>
        `;
        feedbackMessage.style.color = '#FFFFFF'; // Change text color to white
        ...
        fetch('http://localhost:3000/save-score', {
            ...
            body: JSON.stringify({ userId, difficulty, type, score, timeTaken })
        })
